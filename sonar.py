...
def enterPlayerMove(previousMoves):
    print('Where do you wnat to drop the next sonar device? (0-59, 0-14) (or type quit)')
    while True:
        move=input()
        if move.lower()=='quit':
        ...
        print('Enter a number from 0 to 59, a space, then a numvber from 0 to 14.')
...
how far away the nearest chest is, or an X if it is beyond sonar device's
...
Press enter to continue...
    ...
    print('''When you drop a sonar device directly on a chest, ypu retrieve it and the other
